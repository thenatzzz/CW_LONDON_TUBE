...
int main() {
	...
	strcpy(route,"NE,NE");
	cout << "Starting at Blackfriars and taking the steps:" << endl;
	cout << route << endl;
	result = validate_route(map, height, width, "Blackfriars", route, destination);
	if(result >= 0) {
	  cout << "is a valid route with " << result <<
	    " line change(s) ending at " << destination << "." << endl;
	} else {
	...
	strcpy(route,"E,E,E,E,E,E,SE,E,E,E,E,SE,E,E");
	cout << "Starting at Holborn and taking the steps:" << endl;
	cout << route << endl;
	result = validate_route(map, height, width, "Holborn", route, destination);
	if(result >= 0) {
	  cout << "is a valid route with " << result <<
	    " line change(s) ending at " << destination << "." << endl;
	} else {
	...
	strcpy(route,"SE,E,E,E,E,E,S");
	cout << "Starting at Waterloo and taking the steps:" << endl;
	cout << route << endl;
